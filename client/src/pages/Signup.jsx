    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <h2 style={{ fontSize: '2rem', fontWeight: 800, color: 'white', margin: '0 0 8px' }}>Create Account</h2>
          <p style={{ color: '#9ca3af', fontSize: '0.9rem', margin: 0 }}>Join the ultimate math duel arena</p>
        </div>
